...
const TeamMemberViewContainer = props => {
    ...
    return(
        <div className='container-div-dashboard'>
            ...
            <TeamMemberNav /> 
            {props.activity === 'calendar' ? <CalendarComponent /> : props.activity === 'projects' ? <ProjectContainer /> : props.activity === 'profile' ? <Profile /> : props.activity === 'team_calendar' ? <TeamCalendar /> : <MyTeam />}
            </div>
        </div>
    )
}
